export default {
	...
	'error-invalid-room': '无效的群组',
	'error-invalid-room-name': '{{room_name}} 不是合法的群组名',
	'error-invalid-room-type': '{{type}} 不是合法的群组类型.',
	...
	Are_you_sure_you_want_to_leave_the_room: '你确定要离开群组 {{room}} 吗?',
	...
	Create_account: '创建账户',
	Create_Channel: '创建频道',
	Create_a_new_workspace: '报名参加训练营',
	Create: '创建',
	Delete_Room_Warning: '删除一个群组将删除群组内的所有消息。这是不可逆转的.',
	delete: '删除',
	Delete: '删除',
	DELETE: '删除',
	description: '描述',
	...
	Do_you_really_want_to_key_this_room_question_mark: '你真的想要{{key}}这个群组吗?',
	edit: '编辑',
	erasing_room: '正抹去群组',
	Edit: '编辑',
	...
	Messages: '消息',
	Microphone_Permission_Message: '发音频消息，需要访问您的麦克风。',
	...
	Notify_active_in_this_room: '通知这个群组的活跃用户',
	Notify_all_in_this_room: '通知这个群组的所有人',
	Offline: '离线',
	Oops: '哎呀!',
	Online: '在线',
	Only_authorized_users_can_write_new_messages: '只有经过授权的用户才能写新消息',
	Open_emoji_selector: '打开emoji选择器',
	Open_Source_Communication: '线上开发技能训练营',
	Password: '密码',
	...
	Roles: '角色',
	Room_actions: '群组操作',
	Room_changed_announcement: '{{userBy}}将群组通知改为：{{announcement}}',
	Room_changed_description: '{{userBy}}将群组说明改为：{{description}}',
	Room_changed_privacy: '{{userBy}}将群组类型改为：{{type}}',
	Room_changed_topic: '{{userBy}}将群组主题改为：{{topic}}',
	Room_Files: '群组文件',
	Room_Info_Edit: '群组信息编辑',
	Room_Info: '群组信息',
	Room_Members: '群组成员',
	Room_name_changed: '{{userBy}}将群组名称改为:{{{name}}',
	SAVE: '保存',
	Save_Changes: '保存更改',
	Save: '保存',
	...
	The_URL_is_invalid: '服务地址无效，再试一次吧。',
	There_was_an_error_while_action: '{{action}}出现错误!',
	This_room_is_blocked: '这个群组被锁了',
	This_room_is_read_only: '此群组只供阅读',
	Timezone: '时区',
	...
	Voice_call: '语音通话',
	Welcome: '欢迎',
	Welcome_to_RocketChat: 'NinghaoCamp',
	Yes_action_it: '是的，{{action}}它！',
	Yesterday: '昨天',
	You_are_in_preview_mode: '您处于预览模式',
	You_are_offline: '您处于离线状态',
	You_can_search_using_RegExp_eg: '搜索中可以使用正则表达式，例如`/^text$/i`',
	You_colon: '你: ',
	...
	Created_snippet: '创建 Snippet',
	Discussions: '讨论',
	edited: '编辑',
	File_description: '文件描述',
	File_name: '文件名',
	Following_thread: '订阅主题',
	Has_joined_the_conversation: '加入交流',
	...
	message: '信息',
	messages: '信息',
	Message_Reported: '举报了信息',
	No_results_found: '没找到结果',
	No_thread_messages: '主题无信息',
	No_messages_yet: '还没有信息',
	Replied_on: '回复：',
	replies: '回复',
	reply: '回复',
	Report: '举报',
	resetting_password: '重置密码',
	Sent_an_attachment: '发送附件',
	Started_discussion: '创建一个讨论：',
	Thread: '主题',
	Threads: '主题',
	Unfollowed_thread: '取消订阅主题',
	Updating: '更新...',
	User_sent_an_attachment: '{{user}}发了一个附件',
